...
<?php echo form_open('news/create'); ?>
    <div  class="transbox" style="margin-top:-20px">
      <p>
        ...
        <input type="input" name="first_name" size="50"/><br>
        <br><label for="last_name">Last Name</label><br>
        <input type="input" name="last_name" size="50"/><br>
