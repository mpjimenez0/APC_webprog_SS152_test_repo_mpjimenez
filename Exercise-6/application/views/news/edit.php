...
<?php echo form_open('news/edit/'.$user_item['user_id']); ?>
            ...
            <input type="input" name="first_name" size="50" value="<?php echo $user_item['first_name'] ?>" /><br>
            <br><label for="last_name">Last Name</label><br>
            <input type="input" name="last_name" size="50" value="<?php echo $user_item['last_name'] ?>" /><br>
            ...
            <input type="input" name="user_city" size="50" value="<?php echo $user_item['user_city'] ?>" /><br>
            ...
            <input type="input" name="mobile" size="50" value="<?php echo $user_item['mobile'] ?>" /><br>
